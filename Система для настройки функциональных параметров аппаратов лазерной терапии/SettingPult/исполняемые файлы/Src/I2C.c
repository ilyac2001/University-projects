...
void I2C2Init(){
	...
	//CLOCK_FREQUENCY - define in CONST.h
	//I2C2->TIMINGR = 0x00 << 28 | 0x03 << 20 | 0x01 << 16 | 0x03 << 8 | 0x09 << 0; //CLOCK_FREQUENCY 8 MHz -> Fast-mode (Fm), 400 kHz
	I2C2->TIMINGR = 0x00200B28; //CLOCK_FREQUENCY 24 MHz -> Fast-mode (Fm), 400 kHz
	//I2C2->TIMINGR = 0x01 << 28 | 0x03 << 20 | 0x02 << 16 | 0x03 << 8 | 0x09 << 0;
